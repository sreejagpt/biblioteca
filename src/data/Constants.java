...
public class Constants {
    ...
    public static final String MOVIE_NOT_AVAILABLE = "That movie is not available.\n";
    public static final String BOOK_NOT_AVAILABLE = "That book is not available.\n";
    ...
    public static final String INVALID_RETURN_MOVIE = "That is not a valid movie to return.\n";
    public static final String VALID_RETURN_BOOK = "Thank you for returning the book.\n";
    public static final String VALID_RETURN_MOVIE = "Thank you for returning the movie.\n";
