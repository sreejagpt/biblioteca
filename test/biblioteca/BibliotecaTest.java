...
public class BibliotecaTest {
	...
	public void getMenuOptions() {
		...
		Assert.assertEquals(util.readFile("printedmenu_prelogin.txt", false), displayMenuAction.execute(library));
	}

	@Test
	public void quitSystemSuccessfully() {
		LibraryAction quitAction = new QuitAction(library);
		Assert.assertEquals(TestConfig.MESSAGE_QUIT_SUCCESSFUL, quitAction.execute(library));
